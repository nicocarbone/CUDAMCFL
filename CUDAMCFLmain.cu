...
//
//
//			CUDA-based Monte Carlo simulation of photon migration in
//layered media with inclusions (CUDAMCML_INC) is based in CUDA-based Monte
//Carlo simulation of photon migration in layered media (CUDAMCML).
//
//			All comments concerning with the original version (CUDAMCML)
//are found in the following:
//
//				Some documentation is avialable for CUDAMCML and
//should have been distrbuted along
//				with this source code. If that is not the case:
//Documentation, source code and executables
//				for CUDAMCML are available for download on our
//webpage:
...
//
//				We encourage the use, and modifcation of this code,
//and hope it will help
//				users/programmers to utilize the power of GPGPU for
//their simulation needs. While we
//				don't have a scientifc publication describing this
//code, we would very much appreciate
//				if you cite our original GPGPU Monte Carlo letter (on
//which CUDAMCML is based) if you
//				use this code or derivations thereof for your own
//scientifc work:
//				E. Alerstam, T. Svensson and S. Andersson-Engels,
//"Parallel computing with graphics processing
//				units for high-speed Monte Carlo simulations of photon
//migration", Journal of Biomedical Optics
//				Letters, 13(6) 060504 (2008).
//
//				To compile and run this code, please visit
//www.nvidia.com and download the necessary
//				CUDA Toolkit and SKD. We also highly recommend the
//Visual Studio wizard
//				(available
//at:http://forums.nvidia.com/index.php?showtopic=69183)
//				if you use Visual Studio 2005
//				(The express edition is available for free at:
